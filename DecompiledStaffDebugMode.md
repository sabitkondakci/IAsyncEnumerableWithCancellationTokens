        ...
        private sealed class <GetStaffList>d__1 : IEnumerable<Staff>, IEnumerable, IEnumerator<Staff>, IDisposable, IEnumerator
        {
            ...
            private bool MoveNext()
            {
                ...
                if (<i>5__2 < count)
                {
                    ...
                    staff.Id = <i>5__2;
                    staff.Name = string.Format("Staff {0}", <i>5__2);
                    staff.DepartmentId = <rand>5__1.Next(1, 51);
                    staff.Salary = <rand>5__1.Next(1500, 10000);
                    <>2__current = staff;
                    <>1__state = 1;
                    return true;
                }
